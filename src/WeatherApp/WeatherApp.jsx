...
const WeatherApp = () => {
  let API_KEY = "14cd1dfd0aa9b9655a5ecaab2b976119";
  ...
  const search = async () => {
    ...
    const humidity = document.getElementsByClassName("wind-rate");
    const wind = document.getElementsByClassName("humidity-percent");
